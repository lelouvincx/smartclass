...
describe('design-system typography', () => {
  ...
  it('loads Material Symbols for icons', () => {
    expect(indexHtml).toContain('fonts.googleapis.com/css2?family=Material+Symbols+Rounded:opsz,wght,FILL,GRAD@20,400,0..1,0&display=block')
  })
})
