...
Desktop uses a fixed, quiet sidebar that people can collapse to the compact labelled-icon rail. Remember that preference on the device and keep the centered content column no wider than 64rem. Main page composition follows a 24–32px vertical rhythm. Cards use 16–24px internal padding and responsive grids rather than fixed card widths.
