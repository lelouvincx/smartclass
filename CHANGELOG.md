...
- Add opt-in structured Worker request logs, convert active production error and audit logs to Cloudflare-indexable objects, and extend release probes to monitor the public Guest exercise list on both production API hosts.
