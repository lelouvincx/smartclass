...
- Let teachers choose whether students can download an exercise's Answer PDF after submitting and reviewing their work.
...
- Let teachers remove students from the active student list while preserving past submissions and blocking removed accounts.
- Let teachers deactivate and reactivate student accounts from the student list.
- Let self-registering students select programmes so teachers can see requested programme access before approval.
