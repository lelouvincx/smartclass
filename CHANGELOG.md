...
- Make the student lecture browser match the teacher curriculum navigator with a wide compact workspace, segmented programme buttons, selected-lesson detail pane, and protected lecture-access regressions.
