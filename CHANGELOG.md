...
- Add a web app manifest and SmartClass home-screen icons for standalone mobile installation. The app remains online-only, with no service worker or offline caching.
