...
- Prompt engaged Guest exercise visitors to register after they submit one local attempt or start a second local attempt in the same workspace. The prompt states that existing guest results stay on the current device.
