...
- Clarify that agents monitor this thread's bot PR and run cleanup automatically after `lelouvincx-bot` merges it. [#153](https://github.com/lelouvincx/smartclass/pull/153)
