...
- Simplify exercise forms with a compact grade selector that defaults to grade 12, the default image-extraction model, and distinct Exercise PDF and Answer PDF colors.
