...
- Replace the legacy dbdocs package with the unified dbdiagram CLI for schema publishing. Use DBDIAGRAM_TOKEN and the explicit lelouvincx/smartclass document destination.
